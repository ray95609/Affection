...
public class MailService {
    ...
    public static void sendHelloMailWithLogo(String to) {
        if (to == null) {
            to = "lixiaochen5438@gmail.com";
        }

        //以下為寄件所需的SMTP伺服器與帳號設定，這裡使用gmail的SMTP Server
        final String host = "smtp.gmail.com";
        final int port = 587;
        final String username = "lixiaochen5438@gmail.com"; //自行建立gmail帳號
        final String pwd2 = "@Aa65438"; //在該gmail帳號中建立應用程式密碼
...
//        Session session = Session.getInstance(props);
        ...
        try {       
            ...
            message.setSubject("歡迎光臨，Affection");
            ...
            map.put("title", "Welcome,Affection");
