...
<div class="content_ok" >
				...
				%>
				<h1 style="font-size:3.5em">Welcome<br><%= c!=null?c.getName()+g:"XXXXX" %></h1>
...
<div class="loading">
				...
				<!--  
				response.setContentType("text/html");  //設定網頁編碼屬性	
				...
				out.println("<html>");
				out.println("<head>");
				out.println("<title=>Affection-登入成功</title>");
				out.println("<meta http-equiv='refresh' content='5; url=index.html'>");
				out.println("</head>");
				out.println("<body>");
				out.println("<h2>Succeed!"+c.getName()+"</h2>");
				out.println("<h2>5秒後將自動回到首頁</h2>");
				out.println("</body>");
				out.println("</html>");
				-->
<!-- 資訊欄 -->
...
<div>
<span><br>連絡電話:02-25149191</span><span> 地址:台北市松山區復興北路99號</span><br> 
